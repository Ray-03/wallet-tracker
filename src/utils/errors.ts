export enum ErrorCode {
  ...
  INVALID_TOPUP_AMOUNT = 'WALLET_INVALID_TOPUP_AMOUNT',
  INVALID_PURCHASE_AMOUNT = 'WALLET_INVALID_PURCHASE_AMOUNT',
  TRANSACTION_NOT_FOUND = 'WALLET_TRANSACTION_NOT_FOUND',
  NO_ITEMS_TO_PURCHASE = 'WALLET_NO_ITEMS_TO_PURCHASE',
  INVALID_REFUND_AMOUNT = 'WALLET_INVALID_REFUND_AMOUNT',
